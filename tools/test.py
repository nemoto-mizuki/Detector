...
def parse_config():
    ...
    parser.add_argument('--ckpt', type=str, default='/media/Elements/Detector/out_dir/waymo_models/centerbaselstm/20230124/ckpt/checkpoint_epoch_10.pth', help='checkpoint to start from')
