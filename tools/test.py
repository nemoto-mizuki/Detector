...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='/media/WD6THDD/Detector/out_dir/waymo_models/vit_centerpoint_ver5/20230124/vit_centerpoint_ver5.yaml', help='specify the config for training')
