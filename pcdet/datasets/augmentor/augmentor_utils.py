...
def random_flip_along_x(gt_boxes, points, return_flip=False, enable=None, split_data=False):
    """
    Args:
...
def random_flip_along_y(gt_boxes, points, return_flip=False, enable=None, split_data=False):
    """
    Args:
        gt_boxes: (N, 7 + C), [x, y, z, dx, dy, dz, heading, [vx], [vy]]
        points: (M, 3 + C)
