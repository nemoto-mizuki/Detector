...
class VoxelBackBone8xMultiFrame(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        ...
        self.conv_input = spconv.SparseSequential(
            spconv.SubMConv3d(input_channels, 16, 3, padding=1,
        ...
        self.conv1 = SparseSequentialBatchdict(
            ...
            special_spconv_fn(16, 16, voxel_stride=1,
                              norm_fn=norm_fn, indice_key='focal1'),
        )
        ...
        self.conv2 = SparseSequentialBatchdict(
            ...
            block(32, 32, 3, norm_fn=norm_fn, padding=1, indice_key='subm2'),
            special_spconv_fn(32, 32, voxel_stride=2,
                              norm_fn=norm_fn, indice_key='focal2'),
        )
        ...
        self.conv3 = SparseSequentialBatchdict(
            ...
            block(64, 64, 3, norm_fn=norm_fn, padding=1, indice_key='subm3'),
            special_spconv_fn(64, 64, voxel_stride=4,
                              norm_fn=norm_fn, indice_key='focal3'),
        )

        self.conv4 = SparseSequentialBatchdict(
            # [400, 352, 11] <- [200, 176, 5]
            block(64, 64, 3, norm_fn=norm_fn, stride=2, padding=(
                0, 1, 1), indice_key='spconv4', conv_type='spconv'),
    ...
    def forward(self, batch_dict):
        ...
        for ind, value in enumerate(batch_dict):
            input_sp_tensor = spconv.SparseConvTensor(
                features=voxel_features[ind],
                indices=voxel_coords[ind].int(),
            ...
            if self.use_img:
                ...
                x_conv1, batch_dict, loss_img = self.conv_focal_multimodal(
            ...
            self.forward_ret_dict['loss_box_of_pts'] = loss1 + \
                loss2 + loss3 + loss4 + loss_img
            # for detection head
            # [200, 176, 5] -> [200, 176, 2]
            out = self.conv_out(x_conv4)

            batch_dict.update['encoded_spconv_tensor'].append([out])

            batch_dict.update['multi_scale_3d_features']['x_conv1'].append([x_conv1])
            batch_dict.update['multi_scale_3d_features']['x_conv2'].append([x_conv2])
            batch_dict.update['multi_scale_3d_features']['x_conv3'].append([x_conv3])
            batch_dict.update['multi_scale_3d_features']['x_conv4'].append([x_conv4])
