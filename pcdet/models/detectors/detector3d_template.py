...
from .. import backbones_2d, backbones_3d, dense_heads, roi_heads, attention_module
...
class Detector3DTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.module_topology = [
            ...
            'self_attention_module', 'backbone_2d', 'dense_head',  'point_head', 'roi_head'
        ]
    ...
    def build_encoder_2d_module(self, model_info_dict):
        ...
        encoder_2d_module = backbones_2d.__all__[self.model_cfg.ENCODER_2D.NAME](
    ...
    def build_cfe(self, model_info_dict):
        ...
        cfe_module = attention_module.__all__[self.model_cfg.CFE.NAME](
    ...
    def build_decoder_2d_module(self, model_info_dict):
        ...
        decoder_2d_module = backbones_2d.__all__[self.model_cfg.DECODER_2D.NAME](
    ...
    def build_self_attention_module(self, model_info_dict):
        if self.model_cfg.get('SELF_ATTENTION', None) is None:
            return None, model_info_dict
        self_attention_module = attention_module.__all__[self.model_cfg.SELF_ATTENTION.NAME](
            model_cfg=self.model_cfg.SELF_ATTENTION,
            dataset=self.dataset
        )
        model_info_dict['module_list'].append(self_attention_module)
        return self_attention_module, model_info_dict
